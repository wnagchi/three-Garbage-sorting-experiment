        ...
        <% for (var i=0;i<nodeList.Count;i++){%>
            ...
            <%} %>
             <%if (nodeList[i].Name=="Animation"){ %>
                ...
                m_arr.push(<%=nodeList[i].Attributes["color"].Value %>)//11 高都
                m_arr.push(<%=nodeList[i].Attributes["Alpha"].Value %>)//12 厚度
                 m_arr.push(<%=nodeList[i].Attributes["time"].Value %>)//13 厚度
                m_arr.push(<%=nodeList[i].Attributes["Row"].Value %>)//14 高都
                m_arr.push(<%=nodeList[i].Attributes["Col"].Value %>)//15 厚度
