...
//    this.m_light.shadow.mapSize.width = 1024;  // default
//    this.m_light.shadow.mapSize.height = 1024; // default
//    this.m_light.shadow.camera.near = 0.5;    // default
//    this.m_light.shadow.camera.far = 2500;     // default
