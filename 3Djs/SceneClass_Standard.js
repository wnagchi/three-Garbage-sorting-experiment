...
BaseScene.prototype.CreateDis = function () {
    ...
    var geometry = new THREE.CylinderGeometry(30, 5, 35); // Create a 20 by 20 by 20 cube.	  
    m_material = new THREE.MeshBasicMaterial({ color: 0xff0000, side: THREE.DoubleSide });
...
BaseScene.prototype.CreateSysWall = function () {
    ...
    for (var i = 0; i < m_VarGlobal.m_XMLWall.length; i++) {
        ...
        if (m_VarGlobal.m_XMLWall[i][0] == "Wall") {
           ...
           // m_VarGlobal.m_BaseSence.bumpMaterial(m_PWall,0);
            //alert(333);
...
BaseScene.prototype.CreateSysPic = function () {
    ...
    for (var i = 0; i < m_VarGlobal.m_XMLWall.length; i++) {
        ...
        if (m_VarGlobal.m_XMLWall[i][0] == "Pic") {
          ...
          //  alert(m_VarGlobal.m_BaseSence.bumpMaterial);
          //  m_VarGlobal.m_BaseSence.bumpMaterial(m_PPic, 1);
...
BaseScene.prototype.CreateTestLoadObj = function (content, url, name) {
    ...
    if (object.name == "t_Roller" || object.name == "t_Rollplug" || object.name == "tWind" || object.name == "font_0" || object.name == "font_1" || object.name == "font_2" || object.name == "font_3") {
    ...
    //    if (object.name == "garbage1" || object.name == "garbage3" ) {

    //        m_VarGlobal.m_NodesMaterial.init(object, "SkinPhong",0xc3726e, 0x433e3d, 0x2f2e2d);
    //    }
    //    if (object.name == "garbage2" || object.name == "garbage4") {

    //        m_VarGlobal.m_NodesMaterial.init(object, "PlushPhong", 0xaa9b7c);
    //    }
...
BaseScene.prototype.bumpMaterial = function (obj, type) {

    var mtl;
    mtl = new THREE.PhongNodeMaterial();
    if (type) {
        var diffuse = new THREE.TextureNode(getTexture("floor"));

        var bump = new THREE.BumpNode(new THREE.TextureNode(getTexture("floor")));
...
BaseScene.prototype.PhongMaterial = function (obj) {
    var mtl;
    mtl = new THREE.PhongNodeMaterial();

    var color = new THREE.ColorNode(0xaa9b7c);
    ...
    mtl.color = color;
    mtl.normal = new THREE.TextureNode(getTexture("toothNormal"));
...
BaseScene.prototype.SkinPhongMaterial = function (obj) {
   
    
    var mtl;
    mtl = new THREE.PhongNodeMaterial();

    var skinColor = new THREE.ColorNode(0xc3726e);
    var bloodColor = new THREE.ColorNode(0x433e3d);
